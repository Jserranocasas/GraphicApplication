...
// - Función callback que será llamada cada vez que el área de dibujo
...
// - Función callback que será llamada cada vez cambie la posicion del cursor
// del ratón sobre el área de dibujo OpenGL.
...
int main() {
	...
	// Recupera la posición del cursor relativa al área de cliente de la ventana.
